/**
 * Ikon SVG modern (gaya Lucide, garis 2px sudut membulat), versi JS untuk
 * konten yang dirender dinamis (gallery.js, wishes.js, cake.js). Sama
 * persis dengan includes/icons.php supaya konsisten di seluruh situs.
 */
...
export function icon(name, className = 'icon') {
  ...
  if (!inner) return '';
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="${className}" aria-hidden="true">${inner}</svg>`;
}
